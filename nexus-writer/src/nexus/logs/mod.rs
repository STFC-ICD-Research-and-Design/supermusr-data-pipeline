...
mod tests {
    ...
    fn test_remove_prefixes() {
        ...
        assert_eq!(&remove_prefixes("one and a half:two and a half"),"two and a half");
        assert_eq!(&remove_prefixes("one and a half:two and a half:three and a half"),"three and a half");
    }
}