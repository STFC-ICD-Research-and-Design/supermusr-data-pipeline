...
//    watcher.start_server(args.observability_address).await;
    ...
    let topics_to_subscribe = [Some(args.control_topic.as_str()), args.event_topic.as_deref(), args.histogram_topic.as_deref()]
        .into_iter()
        .flatten()
        .collect::<Vec<&str>>();
            ...
            Ok(msg) => {
                ...
                if let Some(payload) = msg.payload() {
                    if args
                        ...
                        .unwrap_or(false)   //  This statement should certainly be simplified
                    {
