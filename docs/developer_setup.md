...
- `buildah build -t <component name>:latest --build-arg component=<component name> .` (where `<component name>` is any binary crate): build a container image for a given component
