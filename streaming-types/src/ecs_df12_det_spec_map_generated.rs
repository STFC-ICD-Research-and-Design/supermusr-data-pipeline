...
impl<'a> SpectraDetectorMapping<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        if let Some(x) = args.detector_id {
            builder.add_detector_id(x);
        }
        if let Some(x) = args.spectrum {
            builder.add_spectrum(x);
        }
        builder.finish()
    }
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i32>>>(
                    SpectraDetectorMapping::VT_SPECTRUM,
                    None,
                )
        }
    }
    ...
    pub fn detector_id(&self) -> Option<flatbuffers::Vector<'a, i32>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i32>>>(
                    SpectraDetectorMapping::VT_DETECTOR_ID,
                    None,
                )
        }
    }
    ...
    pub fn n_spectra(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(SpectraDetectorMapping::VT_N_SPECTRA, Some(0))
                .unwrap()
        }
    }
}
...
impl<'a: 'b, 'b> SpectraDetectorMappingBuilder<'a, 'b> {
    ...
    #[inline]
    pub fn add_detector_id(
        &mut self,
        detector_id: flatbuffers::WIPOffset<flatbuffers::Vector<'b, i32>>,
    ) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            SpectraDetectorMapping::VT_DETECTOR_ID,
            detector_id,
    ...
    pub fn add_n_spectra(&mut self, n_spectra: i32) {
        self.fbb_
            .push_slot::<i32>(SpectraDetectorMapping::VT_N_SPECTRA, n_spectra, 0);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    ) -> SpectraDetectorMappingBuilder<'a, 'b> {
...
pub fn root_as_spectra_detector_mapping(
    buf: &[u8],
) -> Result<SpectraDetectorMapping, flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn size_prefixed_root_as_spectra_detector_mapping_unchecked(
    buf: &[u8],
...
#[inline]
pub fn finish_size_prefixed_spectra_detector_mapping_buffer<'a, 'b>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<SpectraDetectorMapping<'a>>,
) {
