...
impl<'a> DigitizerEventListMessage<'a> {
    ...
    pub fn digitizer_id(&self) -> u8 {
        ...
        unsafe {
            self._tab
                .get::<u8>(DigitizerEventListMessage::VT_DIGITIZER_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<FrameMetadataV1>>(
                    DigitizerEventListMessage::VT_METADATA,
                    None,
                )
                .unwrap()
        }
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u32>>>(
                    DigitizerEventListMessage::VT_TIME,
                    None,
                )
        }
    }
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u16>>>(
                    DigitizerEventListMessage::VT_VOLTAGE,
                    None,
                )
        }
    }
    ...
    pub fn channel(&self) -> Option<flatbuffers::Vector<'a, u32>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u32>>>(
                    DigitizerEventListMessage::VT_CHANNEL,
                    None,
                )
        }
    }
...
impl<'a: 'b, 'b> DigitizerEventListMessageBuilder<'a, 'b> {
    ...
    pub fn add_digitizer_id(&mut self, digitizer_id: u8) {
        self.fbb_
            .push_slot::<u8>(DigitizerEventListMessage::VT_DIGITIZER_ID, digitizer_id, 0);
    }
    #[inline]
    ...
    ) -> DigitizerEventListMessageBuilder<'a, 'b> {
    ...
    pub fn finish(self) -> flatbuffers::WIPOffset<DigitizerEventListMessage<'a>> {
        ...
        self.fbb_
            .required(o, DigitizerEventListMessage::VT_METADATA, "metadata");
...
pub fn root_as_digitizer_event_list_message(
    buf: &[u8],
) -> Result<DigitizerEventListMessage, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_digitizer_event_list_message(
    buf: &[u8],
) -> Result<DigitizerEventListMessage, flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_digitizer_event_list_message_unchecked(
    buf: &[u8],
...
pub unsafe fn size_prefixed_root_as_digitizer_event_list_message_unchecked(
    buf: &[u8],
) -> DigitizerEventListMessage {
...
#[inline]
pub fn finish_size_prefixed_digitizer_event_list_message_buffer<'a, 'b>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<DigitizerEventListMessage<'a>>,
) {
