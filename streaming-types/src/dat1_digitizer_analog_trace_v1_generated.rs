...
impl<'a> ChannelTrace<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        if let Some(x) = args.voltage {
            builder.add_voltage(x);
        }
    ...
    pub fn channel(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(ChannelTrace::VT_CHANNEL, Some(0))
                .unwrap()
        }
    }
    #[inline]
...
impl<'a: 'b, 'b> ChannelTraceBuilder<'a, 'b> {
    ...
    pub fn add_channel(&mut self, channel: u32) {
        self.fbb_
            .push_slot::<u32>(ChannelTrace::VT_CHANNEL, channel, 0);
    }
    #[inline]
    pub fn add_voltage(&mut self, voltage: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u16>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(ChannelTrace::VT_VOLTAGE, voltage);
    }
    #[inline]
...
impl<'a> DigitizerAnalogTraceMessage<'a> {
    ...
    pub fn digitizer_id(&self) -> u8 {
        ...
        unsafe {
            self._tab
                .get::<u8>(DigitizerAnalogTraceMessage::VT_DIGITIZER_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn metadata(&self) -> FrameMetadataV1<'a> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<FrameMetadataV1>>(
                    DigitizerAnalogTraceMessage::VT_METADATA,
                    None,
                )
                .unwrap()
        }
    ...
    pub fn sample_rate(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(DigitizerAnalogTraceMessage::VT_SAMPLE_RATE, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn channels(
        &self,
    ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ChannelTrace<'a>>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ChannelTrace>>,
            >>(DigitizerAnalogTraceMessage::VT_CHANNELS, None)
        }
    }
}
...
impl flatbuffers::Verifiable for DigitizerAnalogTraceMessage<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<FrameMetadataV1>>(
                "metadata",
                Self::VT_METADATA,
                true,
            )?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<ChannelTrace>>,
            >>("channels", Self::VT_CHANNELS, false)?
            .finish();
        Ok(())
    }
}
pub struct DigitizerAnalogTraceMessageArgs<'a> {
    ...
    pub channels: Option<
        flatbuffers::WIPOffset<
            flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ChannelTrace<'a>>>,
        >,
    >,
}
...
impl<'a: 'b, 'b> DigitizerAnalogTraceMessageBuilder<'a, 'b> {
    ...
    pub fn add_digitizer_id(&mut self, digitizer_id: u8) {
        self.fbb_.push_slot::<u8>(
            DigitizerAnalogTraceMessage::VT_DIGITIZER_ID,
            digitizer_id,
            0,
        );
    }
    ...
    pub fn add_metadata(&mut self, metadata: flatbuffers::WIPOffset<FrameMetadataV1<'b>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<FrameMetadataV1>>(
                DigitizerAnalogTraceMessage::VT_METADATA,
                metadata,
            );
    }
    ...
    pub fn add_sample_rate(&mut self, sample_rate: u64) {
        self.fbb_
            .push_slot::<u64>(DigitizerAnalogTraceMessage::VT_SAMPLE_RATE, sample_rate, 0);
    }
    #[inline]
    pub fn add_channels(
        &mut self,
        channels: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<ChannelTrace<'b>>>,
        >,
    ) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            DigitizerAnalogTraceMessage::VT_CHANNELS,
            channels,
        );
    }
    #[inline]
    ...
    ) -> DigitizerAnalogTraceMessageBuilder<'a, 'b> {
        let start = _fbb.start_table();
    ...
    pub fn finish(self) -> flatbuffers::WIPOffset<DigitizerAnalogTraceMessage<'a>> {
        let o = self.fbb_.end_table(self.start_);
        self.fbb_
            .required(o, DigitizerAnalogTraceMessage::VT_METADATA, "metadata");
        flatbuffers::WIPOffset::new(o.value())
    }
}
...
pub fn root_as_digitizer_analog_trace_message(
    buf: &[u8],
) -> Result<DigitizerAnalogTraceMessage, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_digitizer_analog_trace_message(
    buf: &[u8],
) -> Result<DigitizerAnalogTraceMessage, flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_digitizer_analog_trace_message_unchecked(
    buf: &[u8],
...
pub unsafe fn size_prefixed_root_as_digitizer_analog_trace_message_unchecked(
    buf: &[u8],
) -> DigitizerAnalogTraceMessage {
...
#[inline]
pub fn finish_size_prefixed_digitizer_analog_trace_message_buffer<'a, 'b>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<DigitizerAnalogTraceMessage<'a>>,
) {
