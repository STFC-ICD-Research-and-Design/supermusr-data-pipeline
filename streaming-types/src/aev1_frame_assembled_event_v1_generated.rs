...
impl<'a> FrameAssembledEventListMessage<'a> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<FrameMetadataV1>>(
                    FrameAssembledEventListMessage::VT_METADATA,
                    None,
                )
                .unwrap()
        }
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u32>>>(
                    FrameAssembledEventListMessage::VT_TIME,
                    None,
                )
        }
    }
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u16>>>(
                    FrameAssembledEventListMessage::VT_VOLTAGE,
                    None,
                )
        }
    }
    ...
    pub fn channel(&self) -> Option<flatbuffers::Vector<'a, u32>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u32>>>(
                    FrameAssembledEventListMessage::VT_CHANNEL,
                    None,
                )
        }
    }
...
impl<'a: 'b, 'b> FrameAssembledEventListMessageBuilder<'a, 'b> {
    ...
    ) -> FrameAssembledEventListMessageBuilder<'a, 'b> {
    ...
    pub fn finish(self) -> flatbuffers::WIPOffset<FrameAssembledEventListMessage<'a>> {
        ...
        self.fbb_
            .required(o, FrameAssembledEventListMessage::VT_METADATA, "metadata");
...
pub fn root_as_frame_assembled_event_list_message(
    buf: &[u8],
) -> Result<FrameAssembledEventListMessage, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_frame_assembled_event_list_message(
    buf: &[u8],
) -> Result<FrameAssembledEventListMessage, flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_frame_assembled_event_list_message_unchecked(
    buf: &[u8],
...
pub unsafe fn size_prefixed_root_as_frame_assembled_event_list_message_unchecked(
    buf: &[u8],
) -> FrameAssembledEventListMessage {
...
#[inline]
pub fn finish_size_prefixed_frame_assembled_event_list_message_buffer<'a, 'b>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<FrameAssembledEventListMessage<'a>>,
) {
