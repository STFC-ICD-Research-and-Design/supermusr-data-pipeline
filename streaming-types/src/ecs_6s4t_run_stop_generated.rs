...
impl<'a> RunStop<'a> {
    ...
    pub fn stop_time(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(RunStop::VT_STOP_TIME, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn run_name(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(RunStop::VT_RUN_NAME, None)
        }
    }
    #[inline]
    pub fn job_id(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(RunStop::VT_JOB_ID, None)
        }
    }
    #[inline]
    pub fn service_id(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(RunStop::VT_SERVICE_ID, None)
        }
    }
    #[inline]
    pub fn command_id(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(RunStop::VT_COMMAND_ID, None)
        }
    }
}
...
impl<'a: 'b, 'b> RunStopBuilder<'a, 'b> {
    ...
    pub fn add_stop_time(&mut self, stop_time: u64) {
        self.fbb_
            .push_slot::<u64>(RunStop::VT_STOP_TIME, stop_time, 0);
    }
    #[inline]
    pub fn add_run_name(&mut self, run_name: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(RunStop::VT_RUN_NAME, run_name);
    }
    #[inline]
    pub fn add_job_id(&mut self, job_id: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(RunStop::VT_JOB_ID, job_id);
    }
    #[inline]
    pub fn add_service_id(&mut self, service_id: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(RunStop::VT_SERVICE_ID, service_id);
    }
    #[inline]
    pub fn add_command_id(&mut self, command_id: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(RunStop::VT_COMMAND_ID, command_id);
    }
    #[inline]
...
pub fn size_prefixed_root_as_run_stop(
    buf: &[u8],
) -> Result<RunStop, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_run_stop_buffer<'a, 'b>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<RunStop<'a>>,
) {
