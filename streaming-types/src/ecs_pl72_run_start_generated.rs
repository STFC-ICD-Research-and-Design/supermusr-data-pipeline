...
impl<'a> RunStart<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        if let Some(x) = args.control_topic {
            builder.add_control_topic(x);
        }
        if let Some(x) = args.metadata {
            builder.add_metadata(x);
        }
        if let Some(x) = args.detector_spectrum_map {
            builder.add_detector_spectrum_map(x);
        }
        ...
        if let Some(x) = args.nexus_structure {
            builder.add_nexus_structure(x);
        }
        if let Some(x) = args.instrument_name {
            builder.add_instrument_name(x);
        }
        if let Some(x) = args.run_name {
            builder.add_run_name(x);
        }
        builder.finish()
    }
    ...
    pub fn start_time(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(RunStart::VT_START_TIME, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn stop_time(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(RunStart::VT_STOP_TIME, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn run_name(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(RunStart::VT_RUN_NAME, None)
        }
    }
    #[inline]
    pub fn instrument_name(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(RunStart::VT_INSTRUMENT_NAME, None)
        }
    }
    #[inline]
    pub fn nexus_structure(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(RunStart::VT_NEXUS_STRUCTURE, None)
        }
    }
    #[inline]
    pub fn job_id(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(RunStart::VT_JOB_ID, None)
        }
    }
    #[inline]
    pub fn broker(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(RunStart::VT_BROKER, None)
        }
    }
    #[inline]
    pub fn service_id(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(RunStart::VT_SERVICE_ID, None)
        }
    }
    #[inline]
    pub fn filename(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(RunStart::VT_FILENAME, None)
        }
    }
    #[inline]
    pub fn n_periods(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(RunStart::VT_N_PERIODS, Some(1))
                .unwrap()
        }
    }
    #[inline]
    pub fn detector_spectrum_map(&self) -> Option<SpectraDetectorMapping<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<SpectraDetectorMapping>>(
                    RunStart::VT_DETECTOR_SPECTRUM_MAP,
                    None,
                )
        }
    }
    ...
    pub fn metadata(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(RunStart::VT_METADATA, None)
        }
    }
    #[inline]
    pub fn control_topic(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(RunStart::VT_CONTROL_TOPIC, None)
        }
    }
}
...
impl flatbuffers::Verifiable for RunStart<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "instrument_name",
                Self::VT_INSTRUMENT_NAME,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "nexus_structure",
                Self::VT_NEXUS_STRUCTURE,
                false,
            )?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<SpectraDetectorMapping>>(
                "detector_spectrum_map",
                Self::VT_DETECTOR_SPECTRUM_MAP,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "metadata",
...
impl<'a: 'b, 'b> RunStartBuilder<'a, 'b> {
    ...
    pub fn add_job_id(&mut self, job_id: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(RunStart::VT_JOB_ID, job_id);
    }
    #[inline]
    pub fn add_broker(&mut self, broker: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(RunStart::VT_BROKER, broker);
    }
    #[inline]
    pub fn add_service_id(&mut self, service_id: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(RunStart::VT_SERVICE_ID, service_id);
    }
    #[inline]
    pub fn add_filename(&mut self, filename: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(RunStart::VT_FILENAME, filename);
    }
    #[inline]
    pub fn add_n_periods(&mut self, n_periods: u32) {
        self.fbb_
            .push_slot::<u32>(RunStart::VT_N_PERIODS, n_periods, 1);
    }
    #[inline]
    pub fn add_detector_spectrum_map(
        &mut self,
        detector_spectrum_map: flatbuffers::WIPOffset<SpectraDetectorMapping<'b>>,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<SpectraDetectorMapping>>(
                RunStart::VT_DETECTOR_SPECTRUM_MAP,
                detector_spectrum_map,
            );
    }
    ...
    pub fn add_metadata(&mut self, metadata: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(RunStart::VT_METADATA, metadata);
    }
    #[inline]
    pub fn add_control_topic(&mut self, control_topic: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            RunStart::VT_CONTROL_TOPIC,
            control_topic,
        );
    }
    #[inline]
...
pub fn size_prefixed_root_as_run_start(
    buf: &[u8],
) -> Result<RunStart, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_run_start_buffer<'a, 'b>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<RunStart<'a>>,
) {
