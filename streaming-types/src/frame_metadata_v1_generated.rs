...
impl<'a> FrameMetadataV1<'a> {
  ...
  pub fn timestamp(&self) -> Option<&'a GpsTime> {
    ...
    // which contains a valid value in this slot
    unsafe { self._tab.get::<GpsTime>(FrameMetadataV1::VT_TIMESTAMP, None)}
  }
  #[inline]
  pub fn period_number(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(FrameMetadataV1::VT_PERIOD_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn protons_per_pulse(&self) -> u8 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u8>(FrameMetadataV1::VT_PROTONS_PER_PULSE, Some(0)).unwrap()}
  }
  #[inline]
  pub fn running(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(FrameMetadataV1::VT_RUNNING, Some(false)).unwrap()}
  }
  #[inline]
  pub fn frame_number(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(FrameMetadataV1::VT_FRAME_NUMBER, Some(0)).unwrap()}
  }
  #[inline]
  pub fn veto_flags(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(FrameMetadataV1::VT_VETO_FLAGS, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b> FrameMetadataV1Builder<'a, 'b> {
  ...
  pub fn add_timestamp(&mut self, timestamp: &GpsTime) {
    self.fbb_.push_slot_always::<&GpsTime>(FrameMetadataV1::VT_TIMESTAMP, timestamp);
  }
  #[inline]
  pub fn add_period_number(&mut self, period_number: u64) {
    self.fbb_.push_slot::<u64>(FrameMetadataV1::VT_PERIOD_NUMBER, period_number, 0);
  }
  #[inline]
  pub fn add_protons_per_pulse(&mut self, protons_per_pulse: u8) {
    self.fbb_.push_slot::<u8>(FrameMetadataV1::VT_PROTONS_PER_PULSE, protons_per_pulse, 0);
  }
  #[inline]
  pub fn add_running(&mut self, running: bool) {
    self.fbb_.push_slot::<bool>(FrameMetadataV1::VT_RUNNING, running, false);
  }
  #[inline]
  pub fn add_frame_number(&mut self, frame_number: u32) {
    self.fbb_.push_slot::<u32>(FrameMetadataV1::VT_FRAME_NUMBER, frame_number, 0);
  }
  #[inline]
  pub fn add_veto_flags(&mut self, veto_flags: u16) {
    self.fbb_.push_slot::<u16>(FrameMetadataV1::VT_VETO_FLAGS, veto_flags, 0);
  }
  #[inline]
