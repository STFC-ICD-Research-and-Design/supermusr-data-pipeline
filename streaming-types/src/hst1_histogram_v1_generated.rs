...
impl<'a> Histogram<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        if let Some(x) = args.counts {
            builder.add_counts(x);
        }
    ...
    pub fn channel(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(Histogram::VT_CHANNEL, Some(0))
                .unwrap()
        }
    }
    #[inline]
...
impl<'a: 'b, 'b> HistogramBuilder<'a, 'b> {
    ...
    pub fn add_channel(&mut self, channel: u32) {
        self.fbb_
            .push_slot::<u32>(Histogram::VT_CHANNEL, channel, 0);
    }
    #[inline]
    pub fn add_counts(&mut self, counts: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u16>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Histogram::VT_COUNTS, counts);
    }
    #[inline]
...
impl<'a> HistogramMessage<'a> {
    ...
    pub fn bin_width(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(HistogramMessage::VT_BIN_WIDTH, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn channels(
        &self,
    ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Histogram<'a>>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Histogram>>,
            >>(HistogramMessage::VT_CHANNELS, None)
        }
    }
}
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Histogram>>,
...
pub struct HistogramMessageArgs<'a> {
    ...
    pub channels: Option<
        flatbuffers::WIPOffset<
            flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Histogram<'a>>>,
        >,
    >,
}
...
impl<'a: 'b, 'b> HistogramMessageBuilder<'a, 'b> {
    ...
    pub fn add_bin_width(&mut self, bin_width: u32) {
        self.fbb_
            .push_slot::<u32>(HistogramMessage::VT_BIN_WIDTH, bin_width, 0);
    }
    #[inline]
    pub fn add_channels(
        &mut self,
        channels: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Histogram<'b>>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(HistogramMessage::VT_CHANNELS, channels);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    ) -> HistogramMessageBuilder<'a, 'b> {
        let start = _fbb.start_table();
    ...
    pub fn finish(self) -> flatbuffers::WIPOffset<HistogramMessage<'a>> {
        let o = self.fbb_.end_table(self.start_);
        self.fbb_
            .required(o, HistogramMessage::VT_METADATA, "metadata");
        flatbuffers::WIPOffset::new(o.value())
    }
}
...
pub fn root_as_histogram_message(
    buf: &[u8],
) -> Result<HistogramMessage, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_histogram_message(
    buf: &[u8],
) -> Result<HistogramMessage, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_histogram_message_buffer<'a, 'b>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<HistogramMessage<'a>>,
) {
