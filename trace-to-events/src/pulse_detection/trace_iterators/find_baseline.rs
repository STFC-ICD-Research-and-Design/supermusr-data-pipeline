...
///
use super::super::{datatype::TracePoint, Real};

use super::iter::TraceIter;
use super::iter::TraceIterType;

#[derive(Default, Clone)]
pub(crate) struct FindBaseline {
    warm_up: usize,
    baseline: Real,
...
where
    I: Iterator,
    I::Item: TracePoint<ValueType = Real>,
{
    type Item = (<I::Item as TracePoint>::TimeType, Real);
...
pub(crate) trait FindBaselineFilter<I>
where
    I: Iterator,
    I::Item: TracePoint,
{
