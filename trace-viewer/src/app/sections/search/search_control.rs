...
use crate::app::server_functions::{CancelSearch, CreateNewSearch, FetchSearchSummaries};
...
pub(crate) fn SearchControl() -> impl IntoView {
    ...
    move || if !create_new_search.pending().get() && !fetch_search_summaries.pending().get() {
        Either::Left(view!{
