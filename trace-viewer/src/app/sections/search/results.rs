...
use crate::{app::{components::{ControlBoxWithLabel, Panel, Section, VerticalBlock}, sections::Display}, structs::SearchResults};
        ...
        <Panel>
            <VerticalBlock>
                ...
                <ControlBoxWithLabel name = "width" label = "Width (px):">
                    <input type = "number" value = "1024" node_ref = width_ref/>
                </ControlBoxWithLabel>

                <ControlBoxWithLabel name = "height" label = "Height (px):">
                    <input type = "number" value = "800" node_ref = height_ref/>
                </ControlBoxWithLabel>
            </VerticalBlock>
        </Panel>
    }
